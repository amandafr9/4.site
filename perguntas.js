criaCartao(
    ...
    'Avatar (2009) Arrecadação total: US$ 2,847 bilhões'
)

criaCartao(
    'Futebol',
    'Qual foi a final e quem ganhou o primeiro mundial de clubes da FIFA?',
    'Corinthians x Vasco, o grande campeão foi o Corinthians'
)

criaCartao(
    'Filmes',
    'Os três Homens-Aranha aparecem juntos em qual dos filmes?',
